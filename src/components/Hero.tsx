...
const Hero = () => {
  ...
  const titleRef = useScrollAnimation<HTMLHeadingElement>({ threshold: 0.5 });
  const subtitleRef = useScrollAnimation<HTMLParagraphElement>({ threshold: 0.5 });
  const contentRef = useScrollAnimation<HTMLDivElement>({ threshold: 0.5 });
    ...
    <section className="min-h-screen pt-20 flex items-center bg-gradient-to-b from-black to-dark-lighter w-full">
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center w-full">
          <p
            ref={subtitleRef}
            className="text-primary font-medium mb-2 scroll-fade-in"
          >
            Hello, I'm
          </p>
          ...
          <h1
            ref={titleRef}
            className="text-2xl md:text-5xl font-bold text-white mb-4 scroll-fade-in"
          >
            Mohammed Tayyab
          </h1>
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-5 sm:gap-5 mt-6 px-8 sm:px-0">
              <button
